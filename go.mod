...
require (
	...
	github.com/uvalib/easystore/uvaeasystore v0.0.0-20240304185620-6836b96ff4b5
...
require (
	...
	github.com/uvalib/librabus-sdk/uvalibrabus v0.0.0-20240304192251-e7218d8ce7e3 // indirect
