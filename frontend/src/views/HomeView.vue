  ...
  <main>
    ...
    <div class="info">
      <p>
        ...
        University community (journal articles, datasets, theses/dissertations, etc.). Anyone can search, view and download content.
      </p>
      <p>
    ...
    <div class="submissions">
      <Card>
        ...
        <template #content>
          <p>
            ...
            <a target="_blank" href="https://library.virginia.edu/libra/open/oc-checklist">LibraOpen Checklist</a> or contact
      ...
      <Card>
        ...
        <template #content>
          <p>
            Deposit your approved UVA electronic thesis or dissertation.
            Before uploading your work, please review our
            <a target="_blank" href="https://library.virginia.edu/libra/etds/etds-checklist">ETD Submission Checklist</a>.
          </p>
          <p>For students submitting approved theses or dissertations</p>
          <Button label="Submit ETD Content" @click="etdClicked"/>
        </template>
      </Card>
    </div>
  </main>
